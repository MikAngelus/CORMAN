...
--
-- Dumping data for table `pubblications`
--

INSERT INTO `pubblications` (`id`, `title`, `type`, `venue`, `multimedia`, `public`, `created_at`, `updated_at`) VALUES
...
--
-- Dumping data for table `user_pubblication`
--

INSERT INTO `user_pubblication` (`id`, `user_id`, `pubblication_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4);
...
INSERT INTO `conferences` (`pubblication_id`, `abstract`, `pages`, `days`, `year`, `key`, `doi`, `ee`, `url`) VALUES
...
INSERT INTO `editorships` (`pubblication_id`, `abstract`, `volume`, `publisher`, `year`, `key`, `doi`, `ee`, `url`) VALUES
...
INSERT INTO `journals` (`pubblication_id`, `abstract`, `volume`, `number`, `pages`, `year`, `key`, `doi`, `ee`, `url`) VALUES

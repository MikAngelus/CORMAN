<div class="col-lg-10">{{$pub->title}}</div>
<div class="col-lg-2">{{$pub->year}}</div>
...
<div class="col-lg-12">{{$pub->venue}}</div>
...
<div class="col-lg-1"><i class="fa fa-pencil fa-2x" href="#"></i></div>

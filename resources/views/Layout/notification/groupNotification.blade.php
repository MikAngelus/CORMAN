...
<div>
    <div class="row align-items-center">
        <div class="col-lg-8">{{ $notification->data['authUser']['first_name'] . ' ' . $notification->data['authUser']['last_name']}} invite you to join the group <strong>{{ $notification->data['group']['name']}}</strong></div>
        <div class="col-lg-4">

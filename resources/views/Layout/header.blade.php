<nav class="navbar navbar-dark bg-white navbar-expand-lg navbar-expand-xl">
    <!-- Navbar content -->
    <a id="brand"
       class="navbar-brand order-1 order-xl-1 order-lg-1 order-md-1 order-sm-1 col-lg-4 col-md-3 col-sm-8 col-8 col-xl-4">CORMAN</a>
    ...
    <div class="order-lg-3 order-md-3 order-sm-2 col-sm-4 collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a id="menuIcon" class="nav-item nav-link fa fa-user-circle fa-2x"
               href="{{ route('users.edit', ['id'=>Auth::user()->id]) }}"><span class="sr-only">(current)</span></a>
